...
function App(){
  ...
  const handleSubmit = (e) => {
    ...
    .then(alert('success ahhh'))
    .catch(alert('fail ahhh'))
  }
  ...
  function updateLoginEmail(pass){
    setLoginEmail(pass.target.value);
  }
       ...
       <p>Already have an Account? Login Below.
        ...
        <div>
          <label htmlFor = 'email-login'>
            ...
            <input   type="email" name = "email" id = 'email-login' value = {LoginEmail} onChange = {updateLoginEmail} placeholder = "Email"/>
        </div>
        ...
        <div>
          <label htmlFor = 'login-password'>
            ...
            <input   type ="password" name = "password" id = 'login-password' value = {LoginPassword} onChange={updateLoginPass}  placeholder = "Password"/>
        </div>
